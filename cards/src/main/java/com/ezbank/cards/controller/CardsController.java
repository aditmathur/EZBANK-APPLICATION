...
import com.ezbank.cards.dto.ResponseDTO;
...
@Tag(name = "CRUD REST APIs for Cards in EZBank", description = "CRUD REST APIs in EZBank to CREATE, UPDATE, FETCH AND DELETE card details")
@RestController
...
public class CardsController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDTO> fetchCardDetails(@RequestHeader("ezbank-correlation-id")String correlationId, @RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") String mobileNumber) {
